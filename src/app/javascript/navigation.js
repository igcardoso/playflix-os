...
function displayPageName(event) {
    setTimeout(function () {
        const pageName = window.history.state
...
function showTab(tabId) {
    ...
    if (
        ...
        FilmPageHeader.classList.toggle(
            "sticky",
            pageAreaWithScroll.scrollTop > 0
        );
        pageAreaWithScroll.addEventListener("scroll", function () {
            FilmPageHeader.classList.toggle(
                "sticky",
        ...
        let episodePageHeader = document.querySelector(
            "#episode-details .header"
        );

        episodePageHeader.classList.toggle(
            "sticky",
            pageAreaWithScroll.scrollTop > 0
        );
        pageAreaWithScroll.addEventListener("scroll", function () {
